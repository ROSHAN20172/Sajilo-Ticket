            ...
            if (operator && operator.email) {
                ...
                <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 600px; margin: 0 auto;">
                    ...
                    <div style="background-color: #f9f9f9; padding: 20px; border: 1px solid #ddd; border-top: none; border-radius: 0 0 5px 5px;">
                        ...
                        <p>Thank you for your continued partnership with Sajilo Ticket.</p>
                        
                        <p>Best regards,<br>Sajilo Ticket Team</p>
                    </div>
                    
                    <div style="text-align: center; margin-top: 20px; font-size: 12px; color: #666;">
                        <p>This is an automated message from Sajilo Ticket booking system.</p>
                    </div>
                </div>
                `;
