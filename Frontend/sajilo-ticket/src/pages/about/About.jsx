    ...
    <div className='w-full space-y-12 pb-16'>
      ...
      <RootLayout className="space-y-16 w-full">
        ...
        <section className="w-full">
          <div className="text-center max-w-4xl mx-auto mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              At Sajilo Ticket, we're on a mission to revolutionize bus travel in Nepal by creating
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-sm p-8 border border-gray-100 hover:shadow-md transition duration-300">
              ...
              <p className="text-gray-600">
                Sajilo Ticket is Nepal's premier online bus ticket booking platform, founded in 2021 with a vision
        ...
        <section className="w-full py-12 bg-gray-50 rounded-2xl">
          <div className="text-center max-w-4xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Why Choose Sajilo Ticket</h2>
            <p className="text-base md:text-lg text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Sajilo Ticket was born from a simple yet powerful idea: to eliminate the hassle of bus ticket booking in Nepal.
        ...
        <section className="w-full bg-primary rounded-2xl p-10 text-center text-white">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join thousands of travelers who have discovered the convenience of booking bus tickets online with Sajilo Ticket.
          </p>
