...
const Faqs = () => {
    ...
    const faqData = {
        general: [
            {
                question: 'What is Sajilo Ticket?',
                answer: 'Sajilo Ticket is Nepal\'s leading online bus ticket booking platform. We connect passengers with bus operators across the country, making it easy to search, compare, and book bus tickets online.'
            },
            {
                question: 'How do I contact customer support?',
                answer: 'You can contact our customer support team via phone at +977 1234567890, email at support@sajiloticket.com, or through the live chat feature on our website. Our support team is available 24/7 for urgent matters.'
            },
            {
                question: 'Is Sajilo Ticket available on mobile devices?',
                answer: 'Yes, Sajilo Ticket is optimized for mobile browsers, and we also have dedicated apps available for both Android and iOS devices. You can download our app from the Google Play Store or Apple App Store.'
            },
            {
                question: 'Which bus operators are available on Sajilo Ticket?',
        ...
        booking: [
            {
                question: 'How do I book a bus ticket on Sajilo Ticket?',
            ...
            },
            {
                ...
                answer: 'Yes, Sajilo Ticket provides interactive seating layouts that allow you to select specific seats based on availability. You can see which seats are available, which are booked, and choose according to your preference.'
            }
        ],
        payment: [
            {
            ...
            },
            {
                ...
                answer: 'Sajilo Ticket charges a small convenience fee for each booking, which is clearly displayed before you complete your payment. The convenience fee varies based on the ticket price and payment method used.'
            },
            {
            ...
            <RootLayout className="space-y-10 w-full">
                ...
                <div className="w-full bg-primary/5 rounded-xl p-8 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        ...
                        <a href="mailto:support@sajiloticket.com" className="px-6 py-3 bg-white text-primary border border-primary font-medium rounded-lg hover:bg-gray-50 transition duration-300">
                            Email Us
                        </a>
                    </div>
                </div>
