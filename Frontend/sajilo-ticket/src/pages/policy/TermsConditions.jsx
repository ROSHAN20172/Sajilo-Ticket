                ...
                <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm p-8 md:p-10">
                    <div className="prose prose-lg max-w-none">
                        ...
                        <p className="mb-6">
                            ...
                            Sajilo Ticket website or mobile application (the "Service") operated by Sajilo Ticket ("us", "we", or "our").
                        </p>
                        ...
                        <p className="mb-6">
                            Sajilo Ticket and its suppliers shall not be liable for any indirect, incidental, special, consequential, or punitive damages,
                        ...
                        <div className="mb-6">
                            <p>Email: terms@sajiloticket.com</p>
