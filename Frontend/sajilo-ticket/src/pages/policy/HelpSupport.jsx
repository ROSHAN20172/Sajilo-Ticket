                            ...
                            <div className="space-y-10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div className="bg-gray-50 rounded-xl p-6 text-center hover:shadow-md transition duration-300">
                                        ...
                                        <a href="mailto:support@sajiloticket.com" className="text-primary font-medium hover:underline">
                                            support@sajiloticket.com
                                        </a>
                                    </div>
