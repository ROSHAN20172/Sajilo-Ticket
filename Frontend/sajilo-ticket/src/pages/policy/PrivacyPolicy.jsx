            ...
            <RootLayout className="w-full">
                <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm p-8 md:p-10">
                    <div className="prose prose-lg max-w-none">
                        ...
                        <p className="mb-6">
                            Sajilo Ticket ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose,
                        ...
                        <div className="mb-6">
                            <p>Email: privacy@sajiloticket.com</p>
