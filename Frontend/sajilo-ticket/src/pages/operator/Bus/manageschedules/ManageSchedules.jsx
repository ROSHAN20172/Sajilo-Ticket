...
// //   const [routes, setRoutes] = useState([]); // All routes for the operator
...
// //   const [dateFilter, setDateFilter] = useState(''); // today, this week, this month, this year
// //   const [searchQuery, setSearchQuery] = useState('');
// //   const [selectedDate, setSelectedDate] = useState(''); // For the date picker

// //   const navigate = useNavigate();
// //   const handleClosePage = () => navigate(-1);

// //   // Form state for schedule
// //   // fromTime and toTime represent the departure and arrival times respectively.
// //   const [formData, setFormData] = useState({
// //     bus: '',
// //     route: '',
// //     scheduleDates: [], // array of date strings in "YYYY-MM-DD" format
// //     fromTime: '',     // departure time at route.from
// //     toTime: '',     // arrival time at route.to
// //     pickupTimes: [],   // array of times (HH:MM) for each pickup location
// //     dropTimes: []      // array of times (HH:MM) for each drop location
// //   });

// //   // Helper: Check if the schedule is upcoming (if any schedule date is today or later)
// //   const isUpcoming = (scheduleDates) => {
// //     const now = new Date();
// //     return scheduleDates.some(d => new Date(d) >= new Date(now.toDateString()));
// //   };

// //   // Fetch schedules (optionally filtering by filterType)
...
// //   // Fetch verified buses for the operator
// //   const fetchBuses = async () => {
// //     try {
// //       const res = await axios.get(`${backendUrl}/api/operator/bus/buses`, {
// //         headers: { Authorization: `Bearer ${operatorData?.token}` }
// //       });
// //       // Only include verified buses
...
// //   // Fetch all routes for the operator
...
// //     const dateStr = new Date(schedule.scheduleDates[0]).toLocaleDateString().toLowerCase();
// //     let searchMatch = busName.includes(query) || dateStr.includes(query);

// //     let dateMatch = true;
// //     if (dateFilter) {
// //       const now = new Date();
// //       const firstDate = new Date(schedule.scheduleDates[0]);
// //       if (dateFilter === 'today') {
// //         dateMatch = firstDate.toDateString() === now.toDateString();
// //       } else if (dateFilter === 'this week') {
// //         const startOfWeek = new Date(now);
// //         startOfWeek.setDate(now.getDate() - now.getDay());
// //         const endOfWeek = new Date(startOfWeek);
// //         endOfWeek.setDate(startOfWeek.getDate() + 6);
// //         dateMatch = firstDate >= startOfWeek && firstDate <= endOfWeek;
// //       } else if (dateFilter === 'this month') {
// //         dateMatch = firstDate.getMonth() === now.getMonth() && firstDate.getFullYear() === now.getFullYear();
// //       } else if (dateFilter === 'this year') {
// //         dateMatch = firstDate.getFullYear() === now.getFullYear();
// //       }
// //     }
...
// //   // When a bus is selected in the form, filter routes for that bus.
// //   useEffect(() => {
// //     if (formData.bus) {
...
// //   // Add selected date to scheduleDates array
// //   const addDate = () => {
// //     if (!selectedDate) {
...
// //   // Remove a date from scheduleDates
...
// //               >
// //                 <Typography variant="body1" className="mb-2"><strong>Bus:</strong> {schedule.bus?.busName || 'N/A'}</Typography>
...
// //               )}
// //             </TextField>
// //             {/* Date Picker for Schedule Dates */}
...
// //               </Button>
// //             </Box>
// //             {/* Display schedule dates as bullet list with delete icon */}
// //             {formData.scheduleDates.length > 0 && (
// //               <Box>
...
// //               </Box>
// //             )}
// //             {/* Instead of plain Start and Reach Time fields, display route details */}
// //             {formData.route && (() => {
...
// //             Are you sure you want to delete the schedule for bus <strong>{deleteConfirmSchedule?.bus?.busName}</strong> on <strong>{new Date(deleteConfirmSchedule?.scheduleDates[0]).toLocaleDateString()}</strong>?
// //           </Typography>
...
// //     fromTime: '',
// //     toTime: '',
// //     pickupTimes: [], // array of times for each pickup location
// //     dropTimes: []    // array of times for each drop location
// //   });

// //   // Helper: Check if schedule is upcoming (if any scheduled date is today or later)
// //   const isUpcoming = (scheduleDates) => {
// //     const now = new Date();
// //     return scheduleDates.some(d => new Date(d) >= new Date(now.toDateString()));
// //   };
...
// //   // Filter schedules: also check each date in the scheduleDates array for dateFilter match.
// //   const filteredSchedules = schedules.filter(schedule => {
// //     const query = searchQuery.toLowerCase();
// //     const busName = schedule.bus?.busName?.toLowerCase() || '';
// //     // Check if any schedule date matches the search query:
...
// //       return;
// //     }
// //     // Validate pickup times if route defines pickup points
// //     const selRoute = filteredRoutes.find(r => r._id === formData.route);
...
// //       }
// //     }
// //     // Validate drop times if route defines drop points
...
// //             <strong>{deleteConfirmSchedule?.scheduleDates.join(', ')}</strong>?
// //           </Typography>
// //           <Box className="flex justify-end gap-2">
// //             <Button variant="outlined" onClick={() => setDeleteConfirmSchedule(null)}>
// //               Cancel
...
//   const [dateFilter, setDateFilter] = useState(''); // today, this week, this month, this year
//   const [searchQuery, setSearchQuery] = useState('');
//   const [selectedDate, setSelectedDate] = useState(''); // for the hidden date input

//   // Reference for the hidden date input used in the search field
...
//   // Filter schedules based on searchQuery and dateFilter.
//   // For date filtering, check each schedule date.
//   const filteredSchedules = schedules.filter(schedule => {
//     const query = searchQuery.toLowerCase();
//     const busName = schedule.bus?.busName?.toLowerCase() || '';
//     const dateSearchMatch = schedule.scheduleDates.some(d =>
...
//               endAdornment: (
//                 <InputAdornment position="end">
//                   <IconButton size="small" onClick={() => hiddenDateInputRef.current && hiddenDateInputRef.current.click()}>
//                     <FaCalendarAlt />
//                   </IconButton>
//                 </InputAdornment>
//               )
...
//             Search
//           </Button>
//           {/* Hidden date input for search */}
//           <input
//             type="date"
//             ref={hiddenDateInputRef}
//             style={{ display: 'none' }}
//             onChange={(e) => {
//               // When a date is picked, convert it to YYYY-MM-DD and set as search query
